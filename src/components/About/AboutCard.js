      ...
      <Card.Body>
        <blockquote className="blockquote mb-0" data-aos="zoom-in">
          <p style={{ textAlign: "justify"}}>
            Hi Everyone, I am <span className="primary-header">Tandel Maan</span> from Surat , Gujarat , india. I am a B.tech Information graduate and a passionate programmer.
            <br />
            <br />
