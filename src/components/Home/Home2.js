        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              <br />Hello, I am <i className="primary-header">
                Maan Tandel
              </i>{" "}, an aspiring <i className="primary-header">
                Information Technology
              </i>{" "} student at Uka Tarsadia University with a passion for web development and front-end development.<br/><br />
               During my recent internship at <i className="primary-header">
               DUCEM Technologies Private Limited
              </i>{" "} in Surat, I had the opportunity to gain valuable hands-on experience in both development and testing through my contributions to the PayWell app project. My journey in the tech world is driven by a desire to create intuitive and impactful web solutions, and I am excited to continue growing and learning in this dynamic field.
              <br /><br />
